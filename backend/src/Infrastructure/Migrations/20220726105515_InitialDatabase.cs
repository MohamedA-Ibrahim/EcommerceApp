        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecieverName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttributeTypes_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttributeValues_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeTypes_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeValues_ItemId",
                table: "AttributeValues",
                column: "ItemId");
