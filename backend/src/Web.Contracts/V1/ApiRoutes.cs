...
public static class ApiRoutes
{
    ...
    public static class Orders
    {
        ...
        public const string ConfirmPayment = Base + "/user/orders/confirmPayment/{orderId}";
        public const string ShipOrder = Base + "/user/orders/shipOrder/{orderId}";
    ...
    public static class AttributeTypes
    {
        ...
        public const string DeleteRange = Base + "/attributeTypes/all/{categoryId}";
    ...
    public static class AttributeValues
    {
        ...
        public const string Delete = Base + "/attributeValues/{attributeValueId}";
        public const string DeleteRange = Base + "/attributeValues/all/{itemId}";
